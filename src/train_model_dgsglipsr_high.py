...
train_glipsm = DatasetFolder("./fg_glips_r2/train", loader=loaderAug, extensions=("mp4"))
val_glipsm = DatasetFolder("./fg_glips_r2/val", loader=loader, extensions=("mp4"))
test_glipsm = DatasetFolder("./fg_glips_r2/test", loader=loader, extensions=("mp4"))
    ...
    def train(model):
        ...
        for i in range(epoch, 10000):
            ...
            for j, ((glipsm_batch_X, glipsm_batch_y), (dgs_batch_X, dgs_batch_y)) in enumerate(zipped):
                ...
                total = total_dgs + total_glipsm
                correct = correct_dgs + correct_glipsm
            ...
            writer.add_scalars("Genauigkeit", {"Train": np.float(str(correct / total*100)), "Val_dgs": np.float(aktuelleVal_dgs), "Val_glipsm": np.float(aktuelleVal_glipsm)}, i)
            writer.flush()
