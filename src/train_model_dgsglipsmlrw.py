...
train_glipsr = DatasetFolder("./fg_lrw2/train", loader=loaderAug, extensions=("mp4"))
val_glipsr = DatasetFolder("./fg_lrw2/val", loader=loader, extensions=("mp4"))
test_glipsr = DatasetFolder("./fg_lrw2/test", loader=loader, extensions=("mp4"))
...
if __name__ == "__main__":
    ...
    checkpoint = torch.load("./ckpt_hps_dgs-glipsm-lrw.pt")
    Model.load_state_dict(checkpoint['model_state_dict'])    
